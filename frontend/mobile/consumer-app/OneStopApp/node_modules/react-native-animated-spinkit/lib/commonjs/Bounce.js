...
class Bounce extends React.Component {
  render() {
    ...
    return /*#__PURE__*/React.createElement(_AnimationContainer.default, {
      initAnimation: () => ({
        bounce: value => (0, _utils.stagger)(1000, 2, {
          duration: 2000,
          value: value,
    ...
    }, rest), values.bounce.map((value, index) => /*#__PURE__*/React.createElement(_reactNative.Animated.View, {
      key: index,
      style: [circleStyle, {
        transform: [{
...
_defineProperty(Bounce, "defaultProps", _SpinnerProps.defaultProps);
