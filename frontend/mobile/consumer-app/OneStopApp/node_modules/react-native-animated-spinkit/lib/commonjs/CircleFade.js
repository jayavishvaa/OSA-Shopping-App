...
class CircleFade extends React.Component {
  render() {
    ...
    return /*#__PURE__*/React.createElement(_AnimationContainer.default, {
      initAnimation: () => ({
        circleFade: value => (0, _utils.stagger)(100, 12, {
          duration: 1200,
          value: value,
    ...
    }, rest), values.circleFade.map((value, index) => /*#__PURE__*/React.createElement(_reactNative.Animated.View, {
      key: index,
      style: [circleStyle, {
...
exports.default = CircleFade;

_defineProperty(CircleFade, "defaultProps", _SpinnerProps.defaultProps);
