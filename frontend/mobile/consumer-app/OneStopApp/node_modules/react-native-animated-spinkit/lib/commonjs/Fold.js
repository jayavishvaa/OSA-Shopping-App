...
class Fold extends React.Component {
  render() {
    ...
    return /*#__PURE__*/React.createElement(_AnimationContainer.default, {
      initAnimation: () => ({
        fold: value => (0, _utils.stagger)(300, 4, {
          duration: 2400,
          value: value,
    ...
    }, rest), values.fold.map((value, index) => /*#__PURE__*/React.createElement(_reactNative.Animated.View, {
...
_defineProperty(Fold, "defaultProps", _SpinnerProps.defaultProps);
