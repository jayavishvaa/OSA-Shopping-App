...
class Wave extends React.Component {
  render() {
    ...
    return /*#__PURE__*/React.createElement(_AnimationContainer.default, {
      initAnimation: () => ({
        wave: value => (0, _utils.stagger)(100, 5, {
          duration: 1200,
          value: value,
    ...
    }, rest), values.wave.map((value, index) => /*#__PURE__*/React.createElement(_reactNative.Animated.View, {
      key: index,
      style: {
        width: size * 0.15,
...
_defineProperty(Wave, "defaultProps", _SpinnerProps.defaultProps);
